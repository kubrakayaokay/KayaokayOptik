    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="list-group">
                <h3>Marka</h3>
                <?php
                foreach($data['brand_data']->result_array() as $row)
                {
                    ?>
            ...
            <div class="list-group">
                ...
                <?php
                foreach($data['frame_material_data']->result_array() as $row)
                {
                    ?>
                    <div class="list-group-item checkbox">
                        <label><input type="checkbox" class="common_selector frame" value="<?php echo $row['frame_material']; ?>"><?php echo $row['frame_material']; ?></label>
                    </div>
                    <?php
                }
                ?>
            ...
            <div class="list-group">
                <h3>Cam Materyali</h3>
                <?php
                foreach($data['glass_material_data']->result_array() as $row)
                {
                    ?>
                    <div class="list-group-item checkbox">
                        <label><input type="checkbox" class="common_selector glass" value="<?php echo $row['glass_material']; ?>"><?php echo $row['glass_material']; ?></label>
                    </div>
                    <?php
                }
                ?>
    ...
    $(document).ready(function(){
        ...
        function filter_data(page)
        {
            ...
            $.ajax({
                ...
                method:"POST",
                dataType:"JSON",
                data:{action:action, minimum_price:minimum_price, maximum_price:maximum_price, brand:brand, frame:frame, glass:glass},
